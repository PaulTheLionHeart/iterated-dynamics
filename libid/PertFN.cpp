...
//	    Z->x = centre->x + temp.BigAbs();
    ...
    void CPertEngine::RefFunctions(Complex *centre, Complex *Z, Complex *ZTimes2)
    {
        ...
        case 12: // Buffalo
            zrsqr = sqr(Z->x);
            zisqr = sqr(Z->y);
            Z->y = fabs(Z->x) * fabs(Z->y) * -2.0 + centre->y;
            temp = zrsqr - zisqr;
            Z->x = fabs(temp) + centre->x;
            break;
        case 13: // Cubic Buffalo
        ...
        case 21: // Cubic Quasi Burning Ship
            ...
            zisqr = sqr(Z->y);
            temp = (zrsqr * 3.0 - zisqr) * Z->y;
            Z->y = -fabs(temp) + centre->y;
            Z->x = centre->x + (zrsqr - zisqr * 3.0) * fabs(Z->x);
            break;
        case 22: // Cubic Partial BS Real
            zrsqr = sqr(Z->x);
            zisqr = sqr(Z->y);
        ...
        case 23: // Cubic Partial BS Imag
            zrsqr = sqr(Z->x);
            zisqr = sqr(Z->y);
            Z->y = (zrsqr * 3.0 - zisqr) * fabs(Z->y) + centre->y;
            Z->x = centre->x + (zrsqr - zisqr * 3.0) * Z->x;
            break;
        case 24: // Cubic Flying Squirrel
            zrsqr = sqr(Z->x);
        ...
        case 25: // Cubic Quasi Perpendicular
            ...
            zisqr = sqr(Z->y);
            temp = zrsqr * 3.0 - zisqr;
            Z->y = -fabs(temp) * Z->y + centre->y;
            Z->x = centre->x + (zrsqr - zisqr * 3.0) * fabs(Z->x);
            break;
        case 26: // 4th Burning Ship Partial Imag
            zrsqr = sqr(Z->x);
            zisqr = sqr(Z->y);
            Z->y = Z->x * fabs(Z->y) * 4.0 * (zrsqr - zisqr) + centre->y;
            Z->x = zrsqr * zrsqr + zisqr * zisqr - zrsqr * zisqr * 6.0 + centre->x;
            break;
        case 27: // 4th Burning Ship Partial Real
            zrsqr = sqr(Z->x);
            zisqr = sqr(Z->y);
            Z->y = fabs(Z->x) * Z->y * 4.0 * (zrsqr - zisqr) + centre->y;
            Z->x = zrsqr * zrsqr + zisqr * zisqr - zrsqr * zisqr * 6.0 + centre->x;
            break;
        case 28: // 4th Burning Ship Partial Real Mbar
            zrsqr = sqr(Z->x);
        ...
        case 34: // 4th False Quasi Perpendicular
            ...
            zisqr = sqr(Z->y);
            temp = (zrsqr - zisqr);
            Z->y = -Z->x * Z->y * fabs(temp) * 4.0 + centre->y;
            Z->x = zrsqr * zrsqr + zisqr * zisqr - zrsqr * zisqr * 6.0 + centre->x;
            break;
        case 35: // 4th False Quasi Heart
            zrsqr = sqr(Z->x);
        ...
        case 38: // 4th Imag Quasi Perpendicular / Heart
            ...
            zisqr = sqr(Z->y);
            temp = (zrsqr - zisqr);
            Z->y = Z->x * fabs(Z->y) * fabs(temp) * 4.0 + centre->y;
            Z->x = zrsqr * zrsqr + zisqr * zisqr - zrsqr * zisqr * 6.0 + centre->x;
            break;
        case 39: // 4th Real Quasi Perpendicular
            zrsqr = sqr(Z->x);
            zisqr = sqr(Z->y);
            temp = (zrsqr - zisqr);
            Z->y = -fabs(Z->x) * Z->y * fabs(temp) * 4.0 + centre->y;
            Z->x = zrsqr * zrsqr + zisqr * zisqr - zrsqr * zisqr * 6.0 + centre->x;
            break;
        case 40: // 4th Real Quasi Heart
            zrsqr = sqr(Z->x);
        ...
        case 44: // 5th Burning Ship Partial
            ...
            RealImagSqr = zrsqr * zisqr;
            Z->y = (sqrsqr.x * 5.0 - RealImagSqr * 10.0 + sqrsqr.y) * Z->y + centre->y;
            Z->x = (sqrsqr.x - RealImagSqr * 10.0 + sqrsqr.y * 5.0) * fabs(Z->x) + centre->x;
            break;
        case 45: // 5th Burning Ship Partial Mbar
            zrsqr = sqr(Z->x);
            zisqr = sqr(Z->y);
        ...
        case 52: // SimonBrot2 4th
            tempzBig = *Z * *Z;
            zabsBig.x = fabs(tempzBig.x);
            zabsBig.y = fabs(tempzBig.y);
            *Z = *Z * *Z * zabsBig;
            Z->y = Z->y + centre->y;
            Z->x = Z->x + centre->x;
            break;
