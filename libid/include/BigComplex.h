...
#include	"BigDouble.h"
#include	"Complex.h"
//#include	"ExpComplex.h"      // add later
...
//	BigComplex & operator =(const ExpComplex &);	// Assignment to a ExpComplex Operator      // add later
...
//	BigComplex operator +(const ExpComplex &);	// complex add by ExpComplex Operator      // add later
