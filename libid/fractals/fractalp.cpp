...
FractalSpecific g_fractal_specific[] =
{
    ...
    */
...

    {
        ...
        {3, 0, 1, 0},
        HelpLabels::HT_NEWTON_COMPLEX, HelpLabels::HF_COMPLEX_NEWTON, FractalFlags::NONE,
        -2.0F, 2.0F, -1.5F, 1.5F,
        0, FractalType::NO_FRACTAL, FractalType::NO_FRACTAL, FractalType::NO_FRACTAL, SymmetryType::NONE,
...

    {
        ...
        {"a", "b", "c", "d"},
        {2.24, .43, -.65, -2.43},
        HelpLabels::HT_PICKOVER, HelpLabels::HF_PICKOVER, FractalFlags::NO_GUESS|FractalFlags::NO_TRACE|FractalFlags::NO_RESUME|FractalFlags::PARAMS_3D,
...

    {
        ...
        {"Initial x", "Initial y", "", ""},
        {-.1, 0, 0, 0},
        HelpLabels::HT_GINGER, HelpLabels::HF_GINGERBREAD, FractalFlags::NO_GUESS|FractalFlags::NO_TRACE|FractalFlags::INF_CALC,
        -4.5F, 8.5F, -4.5F, 8.5F,
        0, FractalType::NO_FRACTAL, FractalType::NO_FRACTAL, FractalType::NO_FRACTAL, SymmetryType::NONE,
...

    {
        ...
        {10, 0, 0, 0},
        HelpLabels::HT_DIFFUSION, HelpLabels::HF_DIFFUSION, FractalFlags::NO_ZOOM|FractalFlags::NO_GUESS|FractalFlags::NO_TRACE,
        -2.0F, 2.0F, -1.5F, 1.5F,
        0, FractalType::NO_FRACTAL, FractalType::NO_FRACTAL, FractalType::NO_FRACTAL, SymmetryType::NONE,
...

    {
        ...
        {"+Order", "", "", ""},
        {2, 0, 0, 0},
        HelpLabels::HT_L_SYSTEM, HelpLabels::SPECIAL_L_SYSTEM, FractalFlags::NO_ZOOM|FractalFlags::NO_RESUME|FractalFlags::NO_GUESS|FractalFlags::NO_TRACE,
        -1.0F, 1.0F, -1.0F, 1.0F,
        1, FractalType::NO_FRACTAL, FractalType::NO_FRACTAL, FractalType::NO_FRACTAL, SymmetryType::NONE,
...

    {
        ...
        {50, .1, 1, 3},
        HelpLabels::HT_DYNAMIC_SYSTEM, HelpLabels::HF_DYNAMIC, FractalFlags::NO_GUESS|FractalFlags::NO_TRACE|FractalFlags::TRIG1,
...

    {
        ...
        {0, 0, 0, 0},
        HelpLabels::HT_QUATERNION, HelpLabels::HF_QUATERNION, FractalFlags::OK_JB,
        -2.0F, 2.0F, -1.5F, 1.5F,
...

    {
        ...
        {"c1", "ci", "cj", "ck"},
        {-.745, 0, .113, .05},
        HelpLabels::HT_QUATERNION, HelpLabels::HF_QUATERNION_JULIA, FractalFlags::OK_JB|FractalFlags::MORE,
        -2.0F, 2.0F, -1.5F, 1.5F,
...

    {
        ...
        {50, 0, 0, 0},
        HelpLabels::HT_MANDEL_CLOUD, HelpLabels::HF_MANDEL_CLOUD, FractalFlags::NO_GUESS|FractalFlags::NO_TRACE,
        -2.5F, 1.5F, -1.5F, 1.5F,
        0, FractalType::NO_FRACTAL, FractalType::NO_FRACTAL, FractalType::NO_FRACTAL, SymmetryType::NONE,
...

    {
        ...
        {"notused", "notused", "cj", "ck"},
        {0, 0, 0, 0},
        HelpLabels::HT_HYPER_COMPLEX, HelpLabels::HF_HYPER_COMPLEX, FractalFlags::OK_JB|FractalFlags::TRIG1,
        -2.0F, 2.0F, -1.5F, 1.5F,
...

    {
        ...
        {"c1", "ci", "cj", "ck"},
        {-.745, 0, .113, .05},
        HelpLabels::HT_HYPER_COMPLEX, HelpLabels::HF_HYPER_COMPLEX_JULIA, FractalFlags::OK_JB|FractalFlags::TRIG1|FractalFlags::MORE,
        -2.0F, 2.0F, -1.5F, 1.5F,
...

    {
        ...
        {"a", "b", "c", ""},
        {34, 1, 5, 0},
        HelpLabels::HT_MARTIN, HelpLabels::HF_QUADRUP_TWO, FractalFlags::NO_GUESS|FractalFlags::NO_TRACE|FractalFlags::INF_CALC,
...

    {
        ...
        {"h", "p", "", ""},
        {0.739, 0.739, 0, 0},
        HelpLabels::HT_VOLTERRA_LOTKA, HelpLabels::HF_VOLTERRA_LOTKA, FractalFlags::NONE,
        0.0F, 6.0F, 0.0F, 4.5F,
        0, FractalType::NO_FRACTAL, FractalType::NO_FRACTAL, FractalType::NO_FRACTAL, SymmetryType::NONE,
    ...
    },
    {
        ...
        {"a", "b", "", ""},
        {2.0, 0.0, 0.0, 0.0},
        HelpLabels::HT_DIVIDE_BROT5, HelpLabels::HF_DIVIDE_BROT5, FractalFlags::BAIL_TEST|FractalFlags::BF_MATH,
        -2.5f, 1.5f, -1.5f, 1.5f,
        0, FractalType::NO_FRACTAL, FractalType::NO_FRACTAL, FractalType::NO_FRACTAL, SymmetryType::NONE,
